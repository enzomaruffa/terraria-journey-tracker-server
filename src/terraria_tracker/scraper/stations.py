...
SPECIAL_STATIONS: dict[str, tuple[int, str]] = {
    ...
    "Water": (-7, "Water.png"),
    "Table and Chair": (-8, "Any Table.gif"),
    "Work Bench and Chair": (-9, "Any Work Bench.gif"),
    ...
    "Work Bench and Ecto Mist": (-15, "Any Work Bench.gif"),
    ...
    "Work Bench and Water": (-22, "Any Work Bench.gif"),
